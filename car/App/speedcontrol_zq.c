...
uint16 angle_center=7500;    //定义中心值   1525  1552   1565   1582
...
/////////////////////   速度设置  /////////////////////////////////
      speed_input();
///////////////////// 差速计算   /////////////n ////////////////////
      nextError=SE_duty-angle_center;        //1552     1518
...
//      s_distance = (int)((s_distance + s_distance_l + s_distance_ll + s_distance_lll)/4);//数据平滑
	...
	if(s_distance<20)
      ...
      speedwant =110;//(int)(speedwantB * 1.2) ;//超声波丢失的话保持设定速度100;//50;//(
//       printf("%d/n",speedwant);
//       printf("%d\n",s_distance);
}
