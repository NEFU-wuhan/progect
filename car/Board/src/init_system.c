...
void init_sys(void)
 {
    ...
    /*  电机PWM初始化  */
    ftm_pwm_init(FTM3, FTM_CH0,50,7500);   // 舵机
    /* 初始化完成 */
//    ftm_pwm_init(FTM0, FTM_CH4,10000, 10000);    //左电机正转
//    ftm_pwm_init(FTM0, FTM_CH5,10000, 10000);    //左电机反转
//    ftm_pwm_init(FTM0, FTM_CH6,10000, 10000);    //右电机反转
//    ftm_pwm_init(FTM0, FTM_CH7,10000, 10000);    //右电机正转
    ...
    NVIC_SetPriority(PORTE_IRQn,4);         //配置优先级     无线中断
...
//    /*开车检测方波管脚，下降沿触发中断*/
//    port_init(PTC18, ALT1 | IRQ_FALLING | PULLUP );           //初始化 PTC18管脚，复用功能为GPIO ，下降沿触发中断，上拉电阻
