...
*例如:           Site_t bmp_site     = {0, 0};                     //显示图像左上角位置
...
/*******************************************************************************
 * Function Name: LCD_float(Site_t site, float num, uint16 Color, uint16 bkColor)
 * Input Param  : 图像位置，显示数字，数字颜色，背景颜色
 * Output Param : 无
 * Description  : 在LCD上显示浮点数
 * Author Data  : 未知
*例如:           static Site_t  site_mid_line={66,76};                     //显示图像左上角位置
