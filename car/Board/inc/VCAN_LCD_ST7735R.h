...
/********************* ST7735R内部实现 ***********************/
//LCD 的管脚定义
#define     LCD_ST7735R_WR    PTC1//  PTC9
#define     LCD_ST7735R_RD    PTC6 // PTC10
#define     LCD_ST7735R_CS    PTC7 // PTC11
#define     LCD_ST7735R_RS    PTC2 // PTC12
#define     LCD_ST7735R_RST   PTC0 // PTC13

//此部分需要修改初始化里的代码
#define     LCD_ST7735R_P0            PTC_B1_OUT // PTC_B0_OUT
#define     LCD_ST7735R_PIN           PTC_B1_IN // PTC_B0_IN
#define     LCD_ST7735R_PDDR_OUT()    (DDRC_B1 = 0xff)  //(DDRC_B0 = 0xff)
#define     LCD_ST7735R_PDDR_IN()     (DDRC_B1 = 0)  //(DDRC_B0 = 0)
